            ...
            <div class="card panel-border panel-primary">
              ...
              <div class="card-body">
                ...
                <form action="/management/owner/cari" method="GET" align="left">
                  <table>
                    <td><a href="/management/owner/tambah" style="margin-right:600px;float:left;" class="btn btn-primary mb-2 text-white"><i class="fas fa-plus-square mr-2 text-white rounded"></i>Tambah
                Owner</a></td>
                <div class="cari">
            ...
            <table class="table table-striped table-bordered text-center">
                ...
                <tbody>
                    ...
                    <td>{{$row->outlet->nama}}</td>
                        <td><a class="fas fa-edit bg-success p-2 text-white rounded" href="/management/owner/edit/{{$row->id}}" data-toggle="tooltip"
                                title="Edit"></a></td>
                        <td><a class="fas fa-trash-alt bg-danger p-2 text-white rounded delete" href="#" owner-id="{{ $row->id }}" id="hapus" data-toggle="tooltip"
                                title="Delete"></a></td>
                    </tr>    
                    @endforeach
...
<script>
  $('.delete').click(function(){
    var user_id = $(this).attr('owner-id');
      swal({
        title: "Yakin ?",
        text: "Mau dihapus data owner dengan id "+user_id +" ??",
        icon: "warning",
        buttons: true,
        dangerMode: true,
      })
      .then((willDelete) => {
        ...
        if (willDelete) {
          window.location = "/management/owner/hapus/"+user_id+"";
        }
      });
    })
