<aside class="main-sidebar sidebar-primary elevation-4" style="background-color:#2F63C7;">
    <!-- Brand Logo -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/management/administrator" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:#ffffff;font-weight:bold">Administrator</p>
                </a>
              </li>
              <li class="nav-item">
