...
<div class="wrapper">
  ...
  <!-- Main Sidebar Container -->
    @include('management/kasir/sidebar');
  {{-- sidebar end --}}
        ...
        <div class="row mt-4 p-3">
          <div class="col-lg col">
            <div class="card panel-border panel-primary">
              <p class="card-header">
                  <i class="fas fa-users" style="color:#2F63C7;"></i><label style="margin-left:5px;color:#2F63C7;"> Data Kasir</label> 
              </p>
              <div class="card-body">
                ...
                <div class="cari">
                    ...
                    <br/>
                    <td><input id="input-produk" class="form-control" type="text" name="cari" placeholder="Cari kasir......" value="{{old('cari')}}"></td>
                </div>
                  </table>
                </form>
