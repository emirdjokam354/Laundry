      ...
      <div class="container-fluid">
        ...
        <div class="row mt-4 p-3">
          <div class="col-lg col">
            ...
            <div class="card">
                <p class="card-header">
                    <i class="fas fa-user-plus" style="color:#2F63C7;"></i><label style="margin-left:5px;color:#2F63C7;">Tambah Data Admin</label> 
                </p>
                <div class="card-body">
                    <form action="/management/administrator/store" method="post" enctype="multipart/form-data">
                         @if ($message = Session::get('success'))
                            <div class="alert alert-success alert-block">
