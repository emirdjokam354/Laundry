        ...
        <div class="row mt-4 p-3">
          <div class="col-lg col">
            ...
            <div class="card panel-border panel-primary">
                <p class="card-header">
                    <i class="fas fa-user-edit" style="color:#2F63C7;"></i><label style="margin-left:5px;color:#2F63C7;">Edit Data Admin</label> 
                </p>
                <div class="card-body">
                    @foreach ($admin as $row)                        
                    <form action="/management/administrator/update" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            @foreach ($outlet as $item)
                               <option  
                               @if ($item->id == $row->outlet_id)
                                   selected
                               @endif value="{{ $item->id }}">{{ $item->id }}. {{$item->nama}}</option> 
                            @endforeach
                            </select>
                            </div>
                        </div>
                        ...
                        <a href="/management/administrator" type="button" class="btn btn-danger" style="margin-top:20px">Kembali</a>
                    </form>
                 @endforeach
                </div>
            </div>
