	...
	<tbody>
		<tr>
			...
			<table cellspacing="0" cellpadding="0" border="0" width="100%">
				<tbody>
					<tr>
						<td><span class="editable-area" id="business_info"><p style="font-size: 18pt;">SnapwashLaundry </p>
<p><br> Jl.Raya Laswi Baleendah No.35<br> Telephon : 085695871343<br> Email: snapwash_laundry@gmail.com</p></span></td>
					</tr>
				</tbody>
			</table>
			</div>
				...
				<tbody>
					<tr>
						...
						<table cellspacing="0" cellpadding="0" border="0">
							<tbody>
								<tr>
									<td style="padding-left:25px;"><span class="editable-area" id="client_info">{{ $data_invoice->pelanggan->nama }}<br>
{{ $data_invoice->pelanggan->alamat }}<br>
Telp: {{ $data_invoice->pelanggan->tlp }}</span></td>
								</tr>
							</tbody>
						</table>
						</div>
			...
			<table cellspacing="0" cellpadding="0" border="0">
				<tbody>
					<tr>
						...
						<td style="padding-left:20px" align="left"><span class="editable-text" id="no">{{ $data_invoice->kode_invoice }}</span></td>
					</tr>
					<tr>
						<td align="right"><strong><span class="editable-text" id="label_date">Tgl. Transaksi</span></strong></td>
						<td style="padding-left:20px" align="left"><span class="editable-text" id="date">{{ $data_invoice->tgl }}</span></td>
					</tr>
					{{-- <tr>
						<td align="right"><strong><span class="editable-text" id="label_date">Jam Transaksi</span></strong></td>
                        <td style="padding-left:20px" align="left"><span class="editable-text" id="date">08:33:02</span></td>
					</tr> --}}
					<tr>
						<td align="right"><strong><span class="editable-text" id="label_date">Tgl. Ambil</span></strong></td>
						<td style="padding-left:20px" align="left"><span class="editable-text" id="date">{{ $data_invoice->tgl_bayar }}</span></td>
					</tr>
				</tbody>
			</table>
			</td>
...
<div id="items-list"><table class="table table-bordered table-condensed table-striped items-table">
    ...
    <tbody>
					...
					<tr>
                <td>1</td>
                <td>{{ $data_invoice->paket->jenis}} </td>
				<td>{{ $data_invoice->paket->nm_paket }}</td>
				<td>{{ $data_invoice->qty }}</td>
                <td>@currency($data_invoice->paket->harga)</td>
				<td>@currency($data_invoice->paket['harga'] * $data_invoice['qty'])</td>
			</tr>
	...
	<tfoot>
			...
			<td coslpan="2">@currency($data_invoice->paket['harga'] * $data_invoice['qty']),-</td>
		</tr>
