        ...
        <div class="row mt-4 p-3">
          <div class="col-lg col">
            ...
            <div class="card panel-border panel-primary">
                <p class="card-header">
                    <i class="fas fa-user-plus" style="color:#2F63C7;"></i><label style="margin-left:5px;color:#2F63C7;">Tambah Data Pelanggan</label> 
                </p>
                <div class="card-body">
                    <form action="/pelanggan/store" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama" required="required" id="inputNama">
                            </div>
                        </div>
                        <div class="form-group row">
